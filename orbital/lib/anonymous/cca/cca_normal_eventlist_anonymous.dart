...
class CCANormalEventlistAnonymous extends StatelessWidget {
  final database = Firestore.instance;
  DocumentSnapshot ccaDocument;

  CCANormalEventlistAnonymous({@required this.ccaDocument});
                      ...
                      child: InkWell(
                          ...
                          onTap: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        EventNormalViewAnonymous(document: document)));
                          },
                          child: ListTile(
                              title: new Text(
